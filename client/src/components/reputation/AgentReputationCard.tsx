...
<<<<<<< HEAD
            ...
            {agentId !== null && identityUrl && (
              <a
                ...
                className="mt-2 inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[11px] font-mono border border-white/10 bg-white/[0.03] text-white/50 hover:text-white hover:border-white/20 transition-colors"
                title="View this agent's ERC-8004 identity NFT on Mantle"
              >
